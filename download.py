...
if __name__ == '__main__':
    ...
    def resize_arg(s):
        try:
            ...
            raise argparse.ArgumentTypeError(
                "Parameter '-resize' not valid. Expected format: WIDTHxHEIGHT. "
                "Example: --resize=32x32 outputs a 32px x 32px file")
    ...
    parser.add_argument('-resize',
                        ...
                        default=None,
                        type=resize_arg,
                        help='Resize the downloaded image in a specific size. Example: --resize=32x32 '
                             "will output a 32px x 32px file")
